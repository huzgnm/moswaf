...
export default {
  ...
  'overview.tile.pageViewsSub': 'отданные страницы, без картинок и скриптов',
  ...
  'overview.tile.uniqueIPsSub': 'сколько разных IP клиентов замечено',
  ...
  'overview.tile.rateOfTraffic': '{percent}% всего трафика',
